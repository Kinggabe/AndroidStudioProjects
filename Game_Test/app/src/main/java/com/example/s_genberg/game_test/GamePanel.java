...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        //player = new Player(BitmapFactory.decodeResource(getResources(), R.drawable.cowfly), 223, 175, 3);
        player = new Player(BitmapFactory.decodeResource(getResources(), R.drawable.newhelicoptercopy), 65, 25, 3);

        smoke = new ArrayList<Smokepuff>();

        smokeStartTimer = System.nanoTime(); //http://www.youpak.com/watch?v=dzyP7iNSYFQ 14:11 MIN
